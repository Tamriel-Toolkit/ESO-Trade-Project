...
- Preserve routes, permissions, all controls/states, filters, sorting, calculations, copy-command semantics, data and API behavior. Approved exception on 15 September 2026: remove user-facing Item Catalog browsing and promotional counts; retain internal item metadata APIs for requests, builds, taxonomy and icons. Old catalog links/presets open listings without dropping their other filters. Only the approved product-brand portion of generated copy changes.
...
- On 15 September 2026 the owner authorized upgrading the running app to this constructed UI. This shipping approval does not waive outstanding technical acceptance checks; #132 and related issues are not automatically closed.
